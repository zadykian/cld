...
// cld setup project, claude's settings for a project, in internal/project, and cld setup
// telemetry, a local OpenTelemetry collector for claude, in internal/telemetry.
